-- Affiche la société, adresse et ville de résidence pour tous les tiers de l’entreprise(client et fournisseur).
...
WHERE NOT EXISTS(
SELECT dc2.REF_PRODUIT AS Produit 
FROM details_commandes dc2
JOIN commandes c2
ON c2.NO_COMMANDE = dc2.NO_COMMANDE
JOIN clients cl2
ON c2.CODE_CLIENT = cl2.CODE_CLIENT
WHERE cl2.VILLE = "Paris" AND dc2.REF_PRODUIT = produits.REF_PRODUIT
)
